...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '--opt', type=str, default='Options/NIR1.yml', help='Path to option YAML file.')
...
def main():
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            # -------------------------------------------
            # print(lq.shape)
            model.feed_train_data({'lq': lq, 'gt': gt, 'seg': seg})
            ...
            if current_iter % opt['logger']['save_checkpoint_freq'] == 0:
                ...
                model.save(epoch, current_iter, best_metric)
    ...
    model.save(epoch=-1, current_iter=-1,best_metric=best_metric)  # -1 stands for the latest
